...
const allMenuItems: MenuItem[] = [
  ...
  { icon: Shield, label: "Admin Overview", href: "/admin", adminOnly: true },
  { icon: FileText, label: "Admin Applications", href: "/admin/applications", adminOnly: true },
  { icon: Users, label: "Admin Freelancers", href: "/admin/freelancers", adminOnly: true },
  { icon: School, label: "Admin Students", href: "/admin/students", adminOnly: true },
  { icon: FolderOpen, label: "Admin Documents", href: "/admin/documents", adminOnly: true },
  { icon: HelpCircle, label: "Admin Support", href: "/admin/support", adminOnly: true },
  { icon: BarChart3, label: "Admin Activity", href: "/admin/activity", adminOnly: true },
  { icon: Bell, label: "Admin Broadcasts", href: "/admin/broadcasts", adminOnly: true },
  { icon: ClipboardList, label: "Admin Tasks", href: "/admin/tasks", adminOnly: true },
];
