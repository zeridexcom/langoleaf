  ...
  return (
    <div className="bg-white dark:bg-[#1a1a2e] border border-gray-200 dark:border-[#2d2d4a] rounded-2xl p-6 shadow-sm">
      ...
      <div className="space-y-4">
        {/* Total Earned */}
        <div className="p-4 bg-gray-50 dark:bg-[#252542] rounded-xl">
        ...
        <div className="p-4 bg-gray-50 dark:bg-[#252542] rounded-xl">
          ...
          <p className="text-2xl font-bold text-gray-900 dark:text-white">₹{thisMonth.toLocaleString()}</p>
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">{earnings.length} paid commissions</p>
        </div>
        ...
        <div className="p-4 bg-gray-50 dark:bg-[#252542] rounded-xl">
          ...
          {earnings.length > 0 ? (
            ...
            <p className="text-sm text-gray-400 dark:text-gray-500">No earnings yet</p>
          )}
        </div>
      </div>

      {/* Progress to next tier */}
      <div className="mt-6 p-4 bg-gradient-to-r from-[#6d28d9]/10 to-[#22d3ee]/10 dark:from-[#6d28d9]/20 dark:to-[#22d3ee]/20 rounded-xl border border-[#6d28d9]/20">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-gray-900 dark:text-white font-medium">Bronze Agent</span>
          <span className="text-xs text-gray-500 dark:text-gray-400">Start earning to rank up</span>
        </div>
        <div className="w-full bg-gray-200 dark:bg-[#252542] rounded-full h-2">
          <div 
