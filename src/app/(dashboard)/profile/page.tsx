  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-1">Manage your account and view your achievements</p>
      </div>
        ...
        <div className="lg:col-span-1">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 text-center">
            <div className="relative inline-block">
              ...
              <button className="absolute bottom-0 right-0 p-2 bg-gray-100 dark:bg-gray-800 rounded-full border border-gray-200 dark:border-gray-700 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
            ...
            <p className="text-gray-500 dark:text-gray-400">Freelancer Agent #1234</p>
            
            <div className="flex items-center justify-center gap-1 mt-2">
              <Star className="w-4 h-4 text-amber-400 fill-amber-400" />
              <span className="text-sm text-gray-900 dark:text-white font-medium">4.8</span>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-sm font-medium text-primary">Silver Agent</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-500 dark:text-gray-400">Success Rate</span>
                <span className="text-sm font-medium text-emerald-600 dark:text-emerald-400">78%</span>
              </div>
            </div>
          </div>

          {/* Stats */}
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 mt-6">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={!isEditing}
                    className="w-full pl-10 pr-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-primary/50"
                  />
                </div>
              </div>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-2">Phone</label>
                <div className="relative">
            ...
            <div className="mt-6">
              ...
              <textarea
                ...
                disabled={!isEditing}
                className="w-full px-4 py-3 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-xl text-gray-900 dark:text-white disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-primary/50 resize-none"
              />
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 mt-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { name: "Top Performer", icon: "🏆", color: "from-primary to-accent" },
                { name: "100 Students", icon: "👥", color: "from-emerald-400 to-teal-500" },
                { name: "5-Star Rating", icon: "⭐", color: "from-pink-400 to-rose-500" },
              ].map((badge) => (
                <div key={badge.name} className="text-center p-4 bg-gray-100 dark:bg-gray-800 rounded-xl">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{badge.name}</p>
                </div>
              ))}
            </div>
          </div>
