...
const statusStyles: Record<string, string> = {
  ...
  documents_pending: "bg-amber-100 text-amber-700 dark:bg-amber-500/20 dark:text-amber-400 border border-amber-200 dark:border-amber-500/30",
  under_review: "bg-primary/10 text-primary dark:bg-primary/20 border border-primary/20 dark:border-primary/30",
  approved: "bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-500/30",
  enrolled: "bg-purple-100 text-purple-700 dark:bg-purple-500/20 dark:text-purple-400 border border-purple-200 dark:border-purple-500/30",
  rejected: "bg-red-100 text-red-700 dark:bg-red-500/20 dark:text-red-400 border border-red-200 dark:border-red-500/30",
};
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-primary/50"
          />
        </div>
        <select
          value={statusFilter}
          onChange={(e) => setStatusFilter(e.target.value)}
          className="px-4 py-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary/50"
        >
              ...
              {filteredStudents.length === 0 ? (
                ...
                filteredStudents.map((student) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{student.program}</td>
                    <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{student.university}</td>
                    <td className="px-6 py-4">
                      <span
